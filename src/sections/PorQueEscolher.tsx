  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        {/* Header */}
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 ease-out text-center mb-16">
        ...
        {/* Stats Row */}
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 ease-out mb-16">
        ...
        {/* Differentials Grid */}
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 ease-out grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Trust Badges */}
        <div className="hidden md:flex reveal opacity-0 translate-y-8 transition-all duration-700 ease-out mt-12 flex-wrap justify-center gap-3">
